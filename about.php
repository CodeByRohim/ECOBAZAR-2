...
<?php include 'header.php';?>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="first-img order-1 order-lg-2 col-lg-7">
            <div class="aboutImg">
              <img class="img-fluid" src="./images/aboutStart.png" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            <div class="second-img col-lg-6">
              <div class="aboutImg">
                <img class="img-fluid" src="./images/aboutsMiddle.png" alt="">
              </div>
            </div>
            <div class="second-text col-lg-6">
              <div class="aboutText">
                ...
                <div class="infoMiddle">
                  <div class="leaf">
                    <img class="img-fluid" src="./images/leafabout.png" alt="">
                    <div>
                  ...
                  <div class="leaf">
                    <img class="img-fluid" src="./images/head.png" alt="">
                    <div>
                  ...
                  <div class="leaf">
                    <img class="img-fluid" src="./images/star (1).png" alt="">
                    <div>
                  ...
                  <div class="leaf">
                    <img class="img-fluid" src="./images/rightbag.png" alt="">
                    <div>
                  ...
                  <div class="leaf">
                    <img class="img-fluid" src="./images/cube.png" alt="">
                    <div>
                      <h5>100% Organic Food</h5>
                      <p>100% healthy & Fresh food.</p>
                    </div>
    ...
    <section id="about3">
      <div class="container">
        <div class="row">
          ...
          <div class="first-img order-1 order-lg-2 col-lg-7">
            <div class="aboutImg">
              <img class="img-fluid" src="./images/aboutEnd.png" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="teamWrapper col-lg-12 text-center">
            ...
            <div class="member cardMslider">
              ...
              <div class="member-card">
                <img class="img-fluid" src="./drink-img/team1.png" alt="">
                <div class="name">
                  <h5>Jenny Wilson</h5>
                  <h6>Ceo & Founder</h6>
                </div>
              ...
              <!-- 2 -->
              <div class="member-card">
                <img class="img-fluid" src="./drink-img/team2.png" alt="">
                <div class="name">
                  <h5>Jane Cooper</h5>
                  <h6>Worker</h6>
                </div>
              ...
              <!-- 3 -->
              <div class="member-card">
                <img class="img-fluid" src="./drink-img/team3.png" alt="">
                <div class="name">
                  <h5>Cody Fisher</h5>
              ...
              <!-- 4 -->
              <div class="member-card">
                <img class="img-fluid" src="./drink-img/team4.png" alt="">
                <div class="name">
                  <h5>Robert Fox</h5>
        ...
        <div class="row">
          <div class="testimonialWrapper col-lg-12 text-center">
            ...
            <div class="testCardParent testMslider">
              ...
              <div class="testCard">
                <img class="img-fluid coma" src="./images/Vector.svg" alt="">
                ...
                <div class="profile-name">
                  <div class="pr d-flex align-items-center gap-2">
                    <img class="img-fluid" src="./drink-img/test (3).png" alt="">
              ...
              <div class="testCard">
                ...
                <div class="profile-name">
                  <div class="pr d-flex align-items-center gap-2">
                    <img class="img-fluid" src="./drink-img/test (2).png" alt="">
                    <div class="text-start">
              ...
              <div class="testCard">
                ...
                <div class="profile-name">
                  <div class="pr d-flex align-items-center gap-2">
                    <img class="img-fluid" src="./drink-img/test (1).png" alt="">
                    <div class="text-start">
                      <h5>Eleanor Pena</h5>
                      <h6 class="text-start">Customer</h6>
                    </div>
    ...
    <section id="aboutLogo">
      <div class="container">
        <div class="row">
          <div class="logos">
            <span class="col-6 col-lg-1"><img class="img-fluid" src="./images/steps.svg" alt=""></span>
            <span class="col-6 col-lg-1"><img class="img-fluid" src="./images/mango-1.svg" alt=""></span>
            <span class="col-6 col-lg-1"><img class="img-fluid" src="./images/food2.svg" alt=""></span>
            <span class="col-6 col-lg-1"><img class="img-fluid" src="./images/food.svg" alt=""></span>
            <span class="col-6 col-lg-1"><img class="img-fluid" src="./images/bookoff-corporation-logo.svg"
                alt=""></span>
            <span class="col-6 col-lg-1"><img class="img-fluid" src="./images/gseries.svg" alt=""></span>
          </div>
        </div>
      </div>
