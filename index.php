     ...
     <div id="popup" class="popup">
        <div class="popup-content">
          ...
          <div class="popWrapper">
              <div class="col-12 col-lg-6 popImg">
                <img class="img-fluid" src="./images/popupBG.png" alt="">
              </div>
              <div class="col-12 col-lg-6 popText">
                  ...
                  <div class="wrap">
                      <input class="popCheck" type="checkbox" id="check">
                      <label for="check">Do not show this window</label>
                  </div>
              </div>
          </div>
        </div>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="bannerImg col-lg-6">
                                <img class=" img-fluid" src="./images/Image-removebg-preview.png" alt="">
                                <div class="circle">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="box col-lg-3 active">
                                <i><img class="rounded img-fluid" src="./images/Icon.svg" alt=""></i>
                                <h3>Free Shipping</h3>
                                <p>Free shipping with discount</p>
                            </div>
                            <div class="box col-lg-3">
                                <i><img class="img-fluid" src="./images/Icon(1).svg" alt=""></i>
                                <h3>Great Support 24/7</h3>
                                <p>Instant access to Contact</p>
                            </div>
                            <div class="box col-lg-3">
                                <i><img class="img-fluid" src="./images/Icon(2).svg" alt=""></i>
                                <h3>100% Sucure Payment</h3>
                                <p>We ensure your money is save</p>
                            </div>
                            <div class="box col-lg-3 radius">
                                <i><img class="img-fluid" src="./images/Icon(3).svg" alt=""></i>
                ...
                <div class="row mixit">
                    ...
                    <div class="productCard col-lg-3 mix category-b category-c" data-order="3">
                        ...
                        <div class="overlay">
                            ...
                            <div class="eye d-inline-block"><span class="eye-icon"><img width="24px"
                                        src="./images/product img/Eye 1.svg" alt=""></span></div>
                            <div class="bag newBag"><span class=""><img src="./images/product img/Rectangle.svg"
                                        alt=""></span></div>
                    ...
                    <div class="productCard col-lg-3">
                        ...
                        <img class="img-fluid" src="./images/product img/Image(2).svg" alt="">
                    ...
                    <div class="productCard col-lg-3 mix category-a" data-order="1">
                        ...
                        <img class="img-fluid" src="./images/product img/Image(3).svg" alt="">
        ...
        <section id="specialDeals">
            <div class="d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 productImg text-center">
                    <img class="img-fluid" src="./images/Image(4).svg" alt="">
                </div>
                ...
                <div class=" col-lg-4 col-md-6 productImg2 text-center">
                    <img class="img-fluid" src="./images/Image(5).svg" alt="">
                </div>
            </div>
        </section>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="productCard col-lg-3 col-md-4 col-sm-6">
                            <!-- <span class="product-img"> -->
                            <img class="img-fluid" src="./images/green.svg" alt="">
                            <!-- </span> -->
                            <div class="product-text d-flex align-items-center justify-content-between">
                                <div class="cnt">
                                    <h3>Green Apple</h3>
                            ...
                            <div class="overlay">
                                ...
                                <div class="eye d-inline-block"><span class="eye-icon"><img width="24px"
                                            src="./images/product img/Eye 1.svg" alt=""></span></div>
                                <div class="bag newBag"><span><img src="./images/product img/Rectangle.svg"
                                            alt=""></span></div>
                        ...
                        <div class="productCard col-lg-3 col-md-4 col-sm-6">
                            <!-- <span class="product-img"> -->
                            <img class="img-fluid" src="./images/malta.svg" alt="">
                            <!-- </span> -->
                            <div class="product-text d-flex align-items-center justify-content-between">
                                <div class="cnt">
                        ...
                        <div class="productCard col-lg-3 col-md-4 col-sm-6">
                            ...
                            <img class="img-fluid" src="./images/lettuce.svg" alt="">
                        ...
                        <div class="productCard col-lg-3 col-md-4 col-sm-6">
                            ...
                            <img class="img-fluid" src="./images/eggplant.svg" alt="">
            ...
            <div class="container ">
                ...
                <div class="d-flex justify-content-center overflow">
                    ...
                    <div class="col col-md-6 col-lg-4 reviewBox ">
                        <div class="wrapper ">
                            <span><img class="img-fluid" src="./images/Vector.svg" alt=""></span>
                        ...
                        <div class="customer">
                            <img class="img-fluid" src="./images/]enny.svg" alt="">
                            <h4>Jenny Wilson</h4>
                            <h5>Customer</h5>
                        </div>
                    </div>
                    <div class="col col-md-6 col-lg-4 reviewBox ">
                        ...
                        <div class="customer">
                            <img class="img-fluid" src="./images/howkins.svg" alt="">
                            <h4>Guy Hawkins</h4>
                            <h5>Customer</h5>
                        </div>
                    </div>
                    <div class="col col-md-6 col-lg-4 reviewBox">
                        ...
                        <div class="customer">
                            <img class="img-fluid" src="./images/morphy.svg" alt="">
            ...
            <div class="containe d-flex justify-content-center">
                <section id="videos"> <!--video section-->
                    <div class="video-container">
                       ...
                       <a title="Our Food Video" class="venobox" href="./video/istockphoto-2123071364-640_adpp_is.mp4" ><img class="img-fluid" src="./images/organicPhoto.svg" alt="Promo Video"></a>
            ...
            <div class="container">
                <div class="customRow">
                    <div class="col-lg-4 latestNewsBox">
                        <div class="childBox">
                            <img class="img-fluid" src="./images/orange.svg" alt="">
                            <span class="text">
                                <h3>23</h3>
                                <p>JAN</p>
                            </span>
                    ...
                    <div class="col-lg-4 latestNewsBox">
                        <div class="childBox">
                            <img class="img-fluid" src="./images/mangojuice.svg" alt="">
                            <span class="text">
                                <h3>23</h3>
                                <p>JAN</p>
                            </span>
                    ...
                    <div class="col-lg-4 latestNewsBox">
                        <div class="childBox">
                            <img class="img-fluid" src="./images/pineapple.svg" alt="">
                            <span class="text">
                                <h3>23</h3>
                                <p>JAN</p>
                            </span>
